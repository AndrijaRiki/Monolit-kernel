...
#include "../src/ThreadSleep_C_API_test.hpp"
// TEST 6 (zadatak 4. CPP API i asinhrona promena konteksta)
#include "../src/ConsumerProducer_CPP_API_test.hpp"
#include "../src/System_Mode_test.hpp"
